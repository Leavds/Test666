...
public class EmojiKeyboard {
    ...
    public EmojiKeyboard(Activity activity, EditText editText, View emojiPanelView, View emojiPanelSwitchView) {
        init(activity, editText, emojiPanelView, emojiPanelSwitchView);
    }

    private void init(Activity activity, EditText editText, View emojiPanelView, View emojiPanelSwitchView) {
